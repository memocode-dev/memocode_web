...
export async function generateMetadata({params}: MyBlogMemosProps): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            type: 'article',
            url: `https://memocode.dev/@${username}/memos`,
            ...
            images: [
                {
                    url: 'https://memocode.dev/favicon_500x500.png', // 프로필사진없으면 기본사진으로 구현하기
                    width: 800,
                    height: 600,
        ...
        alternates: {
            canonical: `https://memocode.dev/@${username}/memos`,
            languages: {
                'ko-KR': `https://memocode.dev/@${username}/memos`
            },
        },
        icons: {
            icon: [
...
const MyBlogMemos = async ({params}: MyBlogMemosProps) => {
