...
const QuestionPage__QuestionChildComments__QuestionCreateChildCommentButton = ({
                                                                                   questionId,
                                                                       commentId,
                                                                       commentDeleted
...
export default QuestionPage__QuestionChildComments__QuestionCreateChildCommentButton;